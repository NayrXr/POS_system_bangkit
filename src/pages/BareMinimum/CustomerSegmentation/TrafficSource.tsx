                ...
                <div className="card-body">
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <div>
                            ...
                            <div className="w-full h-3.5 rounded bg-slate-200 dark:bg-zink-600">
                                <div className="h-3.5 rounded bg-yellow-500" style={{width: "81%"}}></div>
                            </div>
                        </div>
                        <div>
                            <div className="flex items-center justify-between gap-4 mb-2">
                            ...
                            <div className="w-full h-3.5 rounded bg-slate-200 dark:bg-zink-600">
                                <div className="h-3.5 rounded bg-green-500" style={{width: "63%"}}></div>
                            </div>
                        </div>
                        <div>
                            <div className="flex items-center justify-between gap-4 mb-2">
                            ...
                            <div className="w-full h-3.5 rounded bg-slate-200 dark:bg-zink-600">
                                <div className="h-3.5 rounded bg-slate-500 dark:text-zink-500" style={{width: "25%"}}></div>
                            </div>
                        </div>
                    </div>
                </div>
